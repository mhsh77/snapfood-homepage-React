...
function Header() {
  return (
    <div className='bg-white w-screen flex flex-col text-gray-400 border-b fixed top-0 z-[100] left-0 max-w-full'>
        <div className='flex flex-row justify-between items-center'>
            <div className='md:space-x-10 space-x-5 text-gray-900 flex flex-row items-center py-3'>
                
                <div className='p-3 font-font flex flex-row'><span className='hidden md:block'>
                    سفارش ها
                    </span>
                    <SubjectOutlinedIcon/>
                </div>
        ...
        <div className='flex flex-row justify-between px-10 text-gray-800 text-sm py-3 overflow-scroll'>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_2.png')}
                    width="40"
                    height="40"
                /> 
                <h1>سوپر مارکت</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_3.png')}
                    width="40"
                    height="40"
                /> 
                <h1>کافه</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_4.png')}
                    width="40"
                    height="40"
                /> 
                <h1>شیرینی</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_5.png')}
                    width="40"
                    height="40"
                /> 
                <h1>نانوایی</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_6.png')}
                    width="40"
                    height="40"
                /> 
                <h1>میوه</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_7.png')}
                    width="40"
                    height="40"
                /> 
                <h1>پروتِین</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_8.png')}
                    width="40"
                    height="40"
                /> 
                <h1>آبمیوه بستنی</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_9.png')}
                    width="40"
                    height="40"
                /> 
                <h1>آجیل</h1>
            ...
            <div className='flex flex-col justify-between items-center min-w-[100px]'>
                <img
                    className=''
                    src={require('../assets/desktop_11.png')}
                    width="40"
                    height="40"
                /> 
                <h1>سایر</h1>
